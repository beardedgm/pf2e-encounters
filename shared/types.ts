...
export type ThreatLevel = keyof typeof THREATS;
...
export const STATS_PUBLISHED: Record<string, MonsterStats> = {
...
export const TEMPLATES: Record<string, EncounterTemplate> = {
  trivial_minions4: { name: '4 Minions', composition: { boss: 0, lieutenant: 0, minion: 4, eliteBoss: 0, apexBoss: 0 }, xp: 40, threat: ['trivial'] },
  trivial_minions2: { name: '2 Minions', composition: { boss: 0, lieutenant: 0, minion: 2, eliteBoss: 0, apexBoss: 0 }, xp: 20, threat: ['trivial'] },
  low_lt_minions: { name: '1 Lieutenant + 2 Minions', composition: { boss: 0, lieutenant: 1, minion: 2, eliteBoss: 0, apexBoss: 0 }, xp: 60, threat: ['low'] },
  low_minions6: { name: '6 Minions', composition: { boss: 0, lieutenant: 0, minion: 6, eliteBoss: 0, apexBoss: 0 }, xp: 60, threat: ['low'] },
  low_solo_lt: { name: '1 Lieutenant', composition: { boss: 0, lieutenant: 1, minion: 0, eliteBoss: 0, apexBoss: 0 }, xp: 40, threat: ['low'] },
  mod_2lt: { name: '2 Lieutenants', composition: { boss: 0, lieutenant: 2, minion: 0, eliteBoss: 0, apexBoss: 0 }, xp: 80, threat: ['moderate'] },
  mod_lt_4min: { name: '1 Lieutenant + 4 Minions', composition: { boss: 0, lieutenant: 1, minion: 4, eliteBoss: 0, apexBoss: 0 }, xp: 80, threat: ['moderate'] },
  mod_minions8: { name: '8 Minions', composition: { boss: 0, lieutenant: 0, minion: 8, eliteBoss: 0, apexBoss: 0 }, xp: 80, threat: ['moderate'] },
  mod_boss: { name: '1 Boss', composition: { boss: 1, lieutenant: 0, minion: 0, eliteBoss: 0, apexBoss: 0 }, xp: 80, threat: ['moderate'] },
  sev_3lt: { name: '3 Lieutenants', composition: { boss: 0, lieutenant: 3, minion: 0, eliteBoss: 0, apexBoss: 0 }, xp: 120, threat: ['severe'] },
  sev_boss_2min: { name: '1 Boss + 2 Minions', composition: { boss: 1, lieutenant: 0, minion: 2, eliteBoss: 0, apexBoss: 0 }, xp: 100, threat: ['severe'] },
  sev_eliteboss: { name: '1 Elite Boss', composition: { boss: 0, lieutenant: 0, minion: 0, eliteBoss: 1, apexBoss: 0 }, xp: 120, threat: ['severe'] },
  ext_boss_lt_2min: { name: '1 Boss + 1 Lieutenant + 2 Minions', composition: { boss: 1, lieutenant: 1, minion: 2, eliteBoss: 0, apexBoss: 0 }, xp: 160, threat: ['extreme'] },
  ext_apexboss: { name: '1 Apex Boss', composition: { boss: 0, lieutenant: 0, minion: 0, eliteBoss: 0, apexBoss: 1 }, xp: 160, threat: ['extreme'] },
};
